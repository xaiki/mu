...
(setq mu4e-draft-mark   gnus-cached-mark
      mu4e-flagged-mark gnus-ticked-mark
      mu4e-new-mark	gnus-unseen-mark
      mu4e-pased-mark	gnus-forwarded-mark
      mu4e-replied-mark gnus-replied-mark
      mu4e-seen-mark    gnus-read-mark
      mu4e-trashed-mark gnus-del-mark
      mu4e-unread-mark  gnus-unread-mark)
